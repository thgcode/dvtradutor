...
{$ENDIF}
  ...
  public
    class function Hash(const k: SOString): int64; virtual;
...
{$ENDIF}
  ...
  ['{4B86A9E3-E094-4E5A-954A-69048B7B6327}']
    ...
    function Format2(const str: SOString): SOString;
...
{$ENDIF}
  ...
  public
    ...
    class function ParseString2(s: PSOChar): ISuperObject;
    ...
    class function ParseFile(const FileName: string; strict: Boolean; partial: boolean = true; const this: ISuperObject = nil; options: TSuperFindOptions = [];
       const put: ISuperObject = nil; dt: TSuperType = stNull): ISuperObject;
    class function ParseFile2(const FileName: string): ISuperObject;
...
{$if (sizeof(Char) = 1)}
function StrLComp(const Str1, Str2: PSOChar; MaxLen: int64): Integer;
var
  P1, P2: PWideChar;
  I: int64;
  C1, C2: WideChar;
...
function StrLen(const Str: PSOChar): int64;
var
  p: PSOChar;
begin
  Result := 0;
...
class function TSuperObject.ParseString2(s: PSOChar): ISuperObject;
begin
  Result := TSuperObject.ParseString (s, false, false, NIL, [], NIL, stNull);
end;
...
class function TSuperObject.ParseFile2(const FileName: string): ISuperObject;
begin
  Result := TSuperObject.ParseFile(Filename, false, false, NIL, [], NIL, stNull);
end;
...
function TSuperObject.Format2(const str: SOString): SOString;
begin
    Result := Format(str, '%', '%');
end;
...
class function TSuperAvlEntry.Hash(const k: SOString): int64;
var
  h: int64;
  i: Integer;
begin
